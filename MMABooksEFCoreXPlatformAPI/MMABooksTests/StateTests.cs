...
namespace MMABooksTests
{
    ...
    public class StateTests
    {
        ...
        /*
         [Test]
         public void DeleteWithFKViolationTest()
         {
             s = dbContext.States.Find("OR");
             dbContext.States.Remove(s);
            Assert.Throws(Microsoft.EntityFrameworkCore.DbUpdateException);
             ...
             object value = Assert.Throws(Microsoft.EntityFrameworkCore.DbUpdateException);
         }
        */
        [Test]
        public void CreateTest()
        {
            ...
            Assert.NotNull(dbContext.States.Find("LL"));
